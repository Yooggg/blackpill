...
#define SPI_FLASH_CMD_UNIQUE_ID 0x4B  //no
...
#define SPI_FLASH_CMD_Enable_Reset 0x66    //no
#define SPI_FLASH_CMD_Reset 0x99			//no
#define SPI_FLASH_READ_STATUS_1 0x05
#define SPI_FLASH_READ_STATUS_2 0x35   		//no
#define SPI_FLASH_READ_STATUS_3 0x15		//no
#define SPI_FLASH_WRITE_STATUS_1 0x01
#define SPI_FLASH_WRITE_STATUS_2 0x31		//no
#define SPI_FLASH_WRITE_STATUS_3 0x11 		//no
...
int fx_flash_sector_erase(fs_media_t* dev, uint32_t blkno);


extern int fx_thread_sleep(uint32_t delay);
